...
var _offers = require("./modules/effects/offers");
var _carousel = require("./vendor/carousel");
var _initTabs = require("./modules/effects/init-tabs");
var _initAccordion = require("./modules/effects/init-accordion");
var _video = require("./modules/effects/video");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _offers.changeOffers)();
  (0, _initAccordion.initAccordions)();
  (0, _video.findVideos)();
  (0, _carousel.sliderCoachers)();
  (0, _carousel.carouselReview)();
  // ---------------------------------
...
},{"./modules/effects/init-accordion":3,"./modules/effects/init-tabs":4,"./modules/effects/offers":5,"./modules/effects/video":7,"./modules/form-validate/form":9,"./modules/modals/init-modals":15,"./utils/ios-vh-fix":19,"./vendor/carousel":21}],2:[function(require,module,exports){
"use strict";
...
},{"./tabs":6}],5:[function(require,module,exports){
"use strict";
...
var buttonsOffers = [document.getElementById('offers-button-1'), document.getElementById('offers-button-6'), document.getElementById('offers-button-12')];
var listOffers = [document.getElementById('offers-list-1'), document.getElementById('offers-list-6'), document.getElementById('offers-list-12')];
var changeOffers = function changeOffers() {
  if (buttonsOffers[0] && listOffers[0]) {
    buttonsOffers[0].addEventListener('click', function () {
  ...
  if (buttonsOffers[1] && listOffers[1]) {
    buttonsOffers[1].addEventListener('click', function () {
  ...
  if (buttonsOffers[2] && listOffers[2]) {
    buttonsOffers[2].addEventListener('click', function () {
...
var setupVideo = function setupVideo(video) {
  var link = document.getElementById('video-on');
...
},{"../../utils/focus-lock":17,"../../utils/scroll-lock":20}],17:[function(require,module,exports){
"use strict";
...
exports.sliderCoachers = exports.carouselReview = void 0;
require("./swiper.js");
...
exports.carouselReview = carouselReview;
var sliderCoachers = function sliderCoachers() {
  if (sliderlList) {
...
exports.sliderCoachers = sliderCoachers;

},{"./swiper.js":22}],22:[function(require,module,exports){
